...
```text
主题：低电量提醒 - 凤凰居11/13号楼 213

【低电量提醒】
位置：青岛校区 凤凰居11/13号楼 213
当前剩余电量：3.50 度
提醒阈值：5.00 度
检测时间：2026-07-06 20:00:00
...
```text
DATABASE_URL="postgresql+psycopg://sdu_power:sdu_power_dev@127.0.0.1:5432/sdu_power"
```
